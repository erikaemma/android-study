...
private const val TAG ="D-CrimeFragment"
...
class CrimeFragment : Fragment(), DatePickerFragment.Callbacks {
    ...
    override fun onStart() {
        ...
        suspectButton.apply {
            ...
            //为了验证当找不到联系人APP时按钮会禁用的语句：添加一个不存在的类别
        ...
        photoView.setOnClickListener {
            ...
            */
            if(photoFile.exists()) {
                ZoomDialogFragment.newInstance(photoFile).apply { show(this@CrimeFragment.parentFragmentManager, DIALOG_PICTURE ) }
            }
        }
    }
