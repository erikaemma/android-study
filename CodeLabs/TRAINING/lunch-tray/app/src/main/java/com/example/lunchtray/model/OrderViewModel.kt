...
class OrderViewModel : ViewModel() {
    ...
    fun entreeChecked(name: String): Boolean {
        return entree.value?.name.equals(menuItems[name]?.name)
    }

    fun sideChecked(name: String): Boolean {
        return side.value?.name.equals(menuItems[name]?.name)
    }

    fun accompanimentChecked(name: String): Boolean {
        return accompaniment.value?.name.equals(menuItems[name]?.name)
    }
}
